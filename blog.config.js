...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'c292b9d038b9442b8fdeb0e69abd9f57,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hemu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢旅行的AI产品经理鼓手', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hemu01.com', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Hemu’Travel', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '探索者', // 站点描述，被notion中的页面描述覆盖
